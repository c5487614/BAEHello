 ...
 */
    ...
    Ext.lib.Ajax = {
        request : function(method, uri, cb, data, options) {
            if(options){
                ...
                if(options.xmlData){
                    ...
                    this.initHeader('Content-Type', '', false);
                    method = 'POST';
        ...
        initHeader:function(label, value, isDefault)
        {
			...
			//Added by Chunhui Chen 20140606 for jsonData posted, we get Content-Type:,application/json
			//we should removed the comma , from ,application/json
			if(value==''){
				return ;
			}
